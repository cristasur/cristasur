...
const icons = {
  ...
  whatsapp: (
    <g fill="currentColor" stroke="none">
      <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.975-1.418A9.955 9.955 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a7.95 7.95 0 0 1-4.076-1.124l-.292-.174-3.038.866.867-3.02-.19-.305A7.955 7.955 0 0 1 4 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8zm4.406-5.884c-.241-.12-1.427-.703-1.648-.784-.22-.08-.381-.12-.541.12-.16.241-.621.784-.762.944-.14.16-.28.18-.521.06-.241-.12-1.018-.375-1.939-1.196-.717-.638-1.2-1.427-1.341-1.668-.14-.24-.015-.37.105-.49.108-.108.241-.281.361-.421.12-.14.16-.241.24-.401.08-.16.04-.301-.02-.421-.06-.12-.541-1.307-.741-1.788-.195-.469-.394-.405-.541-.413l-.461-.008c-.16 0-.421.06-.641.301-.22.241-.841.822-.841 2.005s.861 2.326.981 2.486c.12.16 1.694 2.587 4.106 3.628.574.248 1.022.396 1.371.507.576.183 1.1.157 1.514.095.462-.069 1.427-.583 1.628-1.146.2-.562.2-1.044.14-1.145-.06-.1-.22-.16-.461-.281z" />
    </g>
  ),
  instagram: (
    <>
