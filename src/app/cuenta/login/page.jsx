    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white rounded-2xl shadow-card border border-slate-100 p-8">
        <h1 className="text-2xl font-black text-slate-900">
          {needsTotp ? 'Verificación en dos pasos' : 'Inicia sesión'}
        </h1>
        ...
        <form onSubmit={onSubmit} className="space-y-3 mt-6">
          ...
          {needsTotp && !useBackup && (
            <label className="block">
              ...
              <button
                ...
                className="mt-2 text-xs text-brand-700 hover:text-brand-900 underline underline-offset-2"
              >
          ...
          >
            {busy ? 'Ingresando…' : needsTotp ? 'Verificar' : 'Entrar'}
          </button>
